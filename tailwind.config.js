  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        'base-grey-10': 'var(--base-grey-10)',
        'base-grey-11': 'var(--base-grey-11)',
        ...
        'base-blue-04': 'var(--base-blue-04)',
        'base-blue-05': 'var(--base-blue-05)',
        'base-blue-06': 'var(--base-blue-06)',
        'base-orange-01': 'var(--base-orange-01)',
        'base-orange-02': 'var(--base-orange-02)',
        'base-orange-03': 'var(--base-orange-03)',
        ...
        'base-green-03': 'var(--base-green-03)',
        'base-red-01': 'var(--base-red-01)',
        'base-yellow-01': 'var(--base-yellow-01)',
      },
      borderRadius: {
        button: '0.625rem',
      },
